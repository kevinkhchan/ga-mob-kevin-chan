...
class ArrayTableViewController: UITableViewController {
    ...
    */
    ...
    // allocate name (and animal type) to array animalArray
    let animalArray = [Dog(name: "Rover"), Corgi(name: "Ein"), Labrador(name: "Sadie"), Cat(name: "Mittens"), Birman(name: "Choupette"), ScottishFold(name: "Maru")]
